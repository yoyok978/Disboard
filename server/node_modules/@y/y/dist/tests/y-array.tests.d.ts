export function testBasicUpdate(_tc: t.TestCase): void;
export function testFailsObjectManipulationInDevMode(_tc: t.TestCase): void;
export function testSlice(_tc: t.TestCase): void;
export function testArrayFrom(_tc: t.TestCase): void;
export function testLengthIssue(_tc: t.TestCase): void;
export function testLengthIssue2(_tc: t.TestCase): void;
...
export function testIteratingArrayContainingTypes(_tc: t.TestCase): void;
